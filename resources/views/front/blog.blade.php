...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md offset-md-2" style="z-index: 10;">
                    <h1 class="d-inline-block bg-white text-primary fw-bold rounded-top py-3 px-4 mb-0">{!! trans("Blog.title") !!}</h1>
                </div>
            </div>
        </div>
    </header>
    @foreach($blogs as $blog)
        @if($blog->align == 'left')
        <section class="{{$blog->color}} py-6" id="post{{$blog->id}}">
            <div class="container">
                <div class="text-center mb-5" data-aos="fade-up">
                    <h1 class="text-primary h3 fw-bold mb-0">{{$blog->title}}</h1>
                </div>
                <div class="clearfix">
                    <img src="{{$blog->image}}" class="col-md-6 float-md-start mb-3 me-md-3 img-fluid" alt="...">
                    {!!$blog->text!!}
                </div>
        ...
        <section class="{{$blog->color}} py-6" id="post{{$blog->id}}">
            <div class="container">
                ...
                <div class="clearfix">
                    <img src="{{$blog->image}}" class="col-md-6 float-md-end mb-3 ms-md-3 img-fluid" alt="...">
                    {!!$blog->text!!}
                </div>
