...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md offset-md-2" style="z-index: 10;">
                    <h1 class="d-inline-block bg-white text-primary fw-bold rounded-top py-3 px-4 mb-0">{!! trans("Resources.title") !!}</h1>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-6">
                    <div class="d-flex flex-column justify-content-center align-items-start h-100 py-5 py-lg-7 px-4 px-lg-7" data-aos="fade-up">
                        <h3 class="text-primary fw-bold mb-5">{!! trans("Resources.touch.title") !!}</h3>
                        <p class="tx-4 mb-4">{!! trans("Resources.touch.content") !!}</p>
                        <a href="/join-us#contacForm" class="btn btn-primary btn-lg px-4 text-capitalize">{!! trans("Resources.touch.button") !!}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-blue py-6" id="news">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                <h1 class="text-primary h3 fw-bold mb-0 ">{!! trans("Stories.articles.title") !!}</h1>
            </div>
    ...
    <section id="videos" class="bg-secondary py-5">
        <div class="container">
            ...
            <div class="text-center mt-5 mt-lg-7" data-aos="fade-up">
                <a href="https://www.youtube.com/channel/UCqm1YqvHZcTkf-ClFNroHlA" target="_blank" class="btn btn-primary px-4 ">{!! trans("Resources.videos.button") !!}</a>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-6">
                    <div class="bg-green d-flex flex-column justify-content-center align-items-start h-100 py-5 py-lg-7 px-4 px-lg-7">
                        <h3 class="text-primary fw-bold mb-5 text-capitalize" data-aos="fade-up">{!! trans("Resources.storie.title") !!}</h3>
                        <p class="tx-4 mb-4" data-aos="fade-up" data-aos-delay="150">{!! trans("Resources.storie.content") !!}</p>
                        <a href="#subscribe-form" class="btn btn-primary btn-lg px-4 " data-aos="fade-up" data-aos-delay="150">
                            {!! trans("Resources.storie.button") !!}
                        </a>
                    </div>
                </div>
            </div>
