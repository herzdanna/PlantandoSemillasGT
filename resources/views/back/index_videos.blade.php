...
<body>
            ...
            <div class="main-content-inner">
                <div class="row">
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title" style="display: inline-block;">Videos </h4>
                                        ...
                                        <table class="table text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td><img src="{{$video->image}}" style="width: 60px; height: 50px;"></td>
                                                    <td>{{$video->title}}</td>
                                                    <td>{{$video->url}}</td>
                                                    <td>
                                                        <a href="#" data-toggle="modal" data-target=".modaledit" onclick="loadData('{{$video->id}}')" style="color: #3551dc;font-size: 18px;"><i class="ti-pencil"></i></a>
                                                    </td>
                                                    <td>
                                                        <a href="/admin/video/delete/{{$video->id}}" style="color: #dc3545;font-size: 18px;"><i class="ti-trash"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                          <div class="input-icon">
                            <i class="lni-user"></i>
                            <input type="text" class="form-control" id="title" name="title" placeholder="Title" required maxlength="120"/>
                          </div>
                        </div> 
                        <div class="form-group">
                          <div class="input-icon">
                            <i class="lni-user"></i>
                            <input type="text" class="form-control" id="url" name="url" placeholder="Url" required maxlength="149"/>
                          </div>
                        </div>
    ...
    <div class="modal fade modaledit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" action="/editVideo" enctype="multipart/form-data">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                          <div class="input-icon">
                            <i class="lni-user"></i>
                            <input type="text" class="form-control" id="title_edit" name="title" placeholder="Title" required maxlength="120"/>
                          </div>
                        </div> 
                        <div class="form-group">
                          <div class="input-icon">
                            <i class="lni-user"></i>
                            <input type="text" class="form-control" id="url_edit" name="url" placeholder="Url" required maxlength="149"/>
                          </div>
                        </div>
                        <div class="upload__box">
                            <div class="upload__btn-box">
    ...
    <script>
        function loadData(id){
            ...
            success : function(video){
                document.getElementById('title_edit').value = video.title;
                document.getElementById('url_edit').value = video.url;
