...
<body>
            ...
            <div class="main-content-inner">
                <div class="row">
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title" style="display: inline-block;">Partners </h4>
                                        ...
                                        <table class="table text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td><img src="{{$partner->foto}}" style="width: 60px; height: 50px;"></td>
                                                    <td>{{$partner->title}}</td>
                                                    <td>
                                                        <a href="#" data-toggle="modal" data-target=".modaledit" onclick="loadData('{{$partner->id}}')" style="color: #3551dc;font-size: 18px;"><i class="ti-pencil"></i></a>
                                                    </td>
                                                    <td>
                                                        <a href="/admin/partners/delete/{{$partner->id}}" style="color: #dc3545;font-size: 18px;"><i class="ti-trash"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
    ...
    <div class="modal fade modaledit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" action="/editPartner" enctype="multipart/form-data">
                    <div class="modal-header">
    ...
    <script>
        function loadData(id){
            ...
            success : function(partner){
                document.getElementById('title_edit').value = partner.title;
                document.getElementById('id_partner').value = partner.id;
            },
